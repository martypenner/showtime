...
flags="-sUSE_GLFW=3 -sWASM_BIGINT -sWARN_ON_UNDEFINED_SYMBOLS=0 -sASSERTIONS -sEXPORTED_RUNTIME_METHODS=HEAPF32 -sINITIAL_MEMORY=128MB --shell-file source/main_web/index_template.html --preload-file assets"
